...
import 'package:doctor_appointment/design/utils/regex_pattern.dart';
import 'package:doctor_appointment/design/utils/regex_validator.dart';
...
extension StringExtensions on String {
  ...
  bool isSpecialCharacter() =>
      RegVal.hasMatch(this, RegexPattern.specialCharacter);

  bool isHaveAccents() => RegVal.hasMatch(this, RegexPattern.accent);
  ...
  bool isPhoneTemp({bool? checkAll = false}) => checkAll == true
      ? RegVal.matchEveryCharacter(this, RegexPattern.phoneTemp)
      : RegVal.hasMatch(this, RegexPattern.phoneTemp);

  /// Email regex
  bool isEmail() =>
      RegVal.hasMatch(this, RegexPattern.email) ||
      RegVal.hasMatch(this, RegexPattern.googlePatternEmail);
  ...
  /// Optionally, sets of digits in parentheses, separated by spaces, dots, or dashes.
  /// A string starting and ending with a digit, containing digits, spaces, dots, and/or dashes.
  bool isLookLikePhone() => RegVal.hasMatch(this, RegexPattern.lookLikePhone);
  ...
  bool isLanguageCode() => RegVal.hasMatch(this, RegexPattern.langCode);
  ...
  ///But anyway it doesn't really matter what it is, what matters is that you understand how to create such an expression.
  ///Here is a regular expression with annotations to show you what the parts mean
  /// https://stackoverflow.com/questions/3028150/what-is-proper-regex-expression-for-swift-codes
  bool isSwiftCodeRegex() => RegVal.hasMatch(this, RegexPattern.swiftCodeRegex);
}
