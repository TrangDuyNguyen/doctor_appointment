...
class RegexPattern {
  ...
  /// specialCharacter
  static String specialCharacter = "[\$&+,:;=?@#|'<>.^*()%!/0-9_{}\"`~\\[\\]-]";

  static String specialCharacterHotel =
      "[\$&+,:;=?@#|'<>.^*()%!/_{}\"`~\\[\\]-]";

  static String phoneTemp =
      r'(\+[0-9]+[\- \.]*)?(\([0-9]+\)[\- \.]*)?([0-9][0-9\- \.]+[0-9])';

  static String specialCharacterPhone = r'[!@#<>?":_`~;[\]\\|=+)(*&^%]';
  ...
  static String googlePatternEmail =
  ...
  static String phone = r'^\+?([0-9]{1,3})?([0-9]{6,12})$';
  //static String phone = r'^\+\d{1,3}\s?\d{1,14}(\s\d{1,13})?$';

  static String lookLikePhone =
      r'(\+[0-9]+[\- \.]*)?(\([0-9]+\)[\- \.]*)?([0-9][0-9\- \.]+[0-9])$';
  ...
  static String langCode = r'^[a-z]{2}$';
  ...
  static String swiftCodeRegex = r'^[A-Z]{6}[A-Z0-9]{2}([A-Z0-9]{3})?$';
}
