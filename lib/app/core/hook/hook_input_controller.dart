...
TextEditingController useDebouncedTextController(
  ...
  final textController = controller ?? useTextEditingControllerSafeDispose();
...
const useTextEditingControllerSafeDispose = _TextEditingControllerHookCreator();
...
class _TextEditingControllerHookState
  ...
  @override
  String get debugLabel => 'useTextEditingControllerSafeDispose';
}
